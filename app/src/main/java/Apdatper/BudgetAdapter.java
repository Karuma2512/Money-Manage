...
public class BudgetAdapter extends RecyclerView.Adapter<BudgetAdapter.BudgetViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BudgetViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            EditText amountEditText = dialogView.findViewById(R.id.txtAmount);
...
//                    budget.setRemaining(updatedRemaining);
    ...
    static class BudgetViewHolder extends RecyclerView.ViewHolder {
        ...
        public BudgetViewHolder(@NonNull View itemView) {
            ...
            amountTextView = itemView.findViewById(R.id.amoutText);
            remainingTextView = itemView.findViewById(R.id.remainingText);
